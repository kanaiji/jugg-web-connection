...
if [ ${OPERATE} == 'apply' ];then
    echo "kubectl apply -f /root/.jenkins/workspace/jugg-web-connection/cicd/dev/jugg-web-connection-deployment.yaml"
         #第一次部署, 找 yaml
   kubectl apply -f /root/.jenkins/workspace/jugg-web-connection/cicd/dev/jugg-web-connection-deployment.yaml
